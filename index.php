...
<script>
    var tour = 1;
    var inner = [
        '<p >Bem-Vindo ao jogo <br><b class=" py-1">"À NOITE NO MUSEU DE AVEIRO"</b><br>Baseado no franchise de filmes "À Noite No Museu".',
        '<p>Este é o teu menu principal. Se quiseres começar a jogar agora, carrega no botão de <b>JOGO</b>!</p> ',
