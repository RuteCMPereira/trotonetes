<section class="row justify-content-center mt-5">
    <div class="col-5 text-center ">
        ...
        <p class="conquista_titulo1">CONQUISTAS</p>
        </a>
    </div>

    <div class="col-5 text-center pl-3 ">
        <p class="conquista_titulo">RANKING</p>
    </div>
</section>
...
<section class="row justify-content-center pt-3 ">
   <div class="col-12">
    <div class="col-7 mx-auto mt-2">
       ...
       <div class="col-11 mx-auto ranking_imagem">
           <img src="images/museu-outside.jpg" class="img-fluid text-center m-0">
       </div>
   </div>
</section>
...
<section class="row justify-content-center pt-3 " style="background-color: #230f1b;">
    <div class="col-3 d-inline-block ml-2">
        <p class="text-center ranking_sub">Posição</p>
    </div>

    <div class="col-8 d-inline-block ml-1 pr-2">
        <p class="text-left pl-3 ranking_sub">Nome</p>
    </div>
</section>
