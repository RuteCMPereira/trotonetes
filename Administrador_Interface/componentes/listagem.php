    ...
    switch ($x) {
            ...
            if (mysqli_stmt_prepare($stmt, $query)) { // Prepare the statement
                ...
                while (mysqli_stmt_fetch($stmt)) {
                    ...
                    echo " <div class=\"row justify-content-around text-center m-3 \">
                                            <section class='col-1 p-2 listagemdecenas hoveri'><i class=\"fas fa-pen \"></i></section>
                                            <section class='col-1 p-2 listagemdecenas'>" . $id . "</section>
                                            <section class='col-5 listagemdecenas p-2'>" . $nome . "</section> 
        ...
        case "salas":
            echo "<div class=\"row justify-content-center caixa4 m-3 p-3\">
                                         ...
                                         <div class=\"row justify-content-center text-center margem1\">
        ...
        case"utilizadores" :
            echo "<div class=\"row justify-content-center caixa4 m-3 p-3\">
                                            ...
                                            <section class=\"col-7 text-center p-0 m-0\"><a href=\"Adicionar.php?add=utilizador\" class=\"w-100  adicionar px-4\">
                                                <b style=\" color: white\">ADICIONAR <i class=\"fas fa-plus fa-1x \"style=\"color:white\"></i></b></a>
                                            </section>
                                         </div>";
            ...
            if (mysqli_stmt_prepare($stmt, $query)) { // Prepare the statement
                ...
                while (mysqli_stmt_fetch($stmt)) {
                    ...
                    echo " <div class=\"row justify-content-around text-center m-3 \">
                                            ...
                                            <section class='col-5 p-2 listagemdecenas'>" . $email . "</section>
